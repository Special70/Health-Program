package process.systemCoreFiles;

public class MenuFileNames {
    // The purpose of this class is to easily modify all mentions of 
    // "pointers" towards a menu. Why? Because as the code gets developed
    // along the way, plans change and the files are going to change too.
